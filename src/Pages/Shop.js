        ...
        <div className={styles.productsRow}>
            ...
            <div className={styles.shopProductDiv}>
                <Link to="/sklep/napoje">
                    <img className={styles.productImage} src="https://www.seekpng.com/png/detail/18-186518_cartoon-soda-png-svg-royalty-free-download-soda.png" alt="Napoje słodzone" />
                </Link>
            </div>
        </div>
    </div>
