        ...
        <div className={styles.productsRow}>
            <div className={styles.shopProductDiv}>
                <Link to="/sklep/cukierki">
                    <img className={styles.productImage} aria-label="Cukierki"
            ...
            <div className={styles.shopProductDiv}>
                <Link to="/sklep/przekaskislone">
                    <img className={styles.productImage} aria-label="Przekąski słone"
            ...
            <div className={styles.shopProductDiv}>
                <Link to="/sklep/czekoladyibatoniki">
                    <img className={styles.productImage} aria-label="Czekolady i batoniki"
            ...
            <div className={styles.shopProductDiv}>
                <Link to="/sklep/napoje">
                    <img className={styles.productImage} aria-label="Napoje słodzone"
